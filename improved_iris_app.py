...
output=st.sidebar.selectbox("Classifier",("Support Vector Machine","Logistic Regression","Random Forest Classifier"))

if st.sidebar.button("Predict"):
    if output=="Support Vector Machine":
        species_type=prediction(svc_model,s_length,s_width,p_length,p_width)
        score=svc_model.score(X_train,y_train)
    elif output=="Logistic Regression":
    ...
    st.write("Accuracy score of model :-",score)
